...
export default function HorizontalShowcase() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen overflow-hidden bg-primary-900">
      ...
      <div
        ref={cardsRef}
        className="absolute top-0 left-0 h-full flex items-center gap-6 sm:gap-8 pl-8 sm:pl-16 lg:pl-24 pr-[50vw]"
      ...
      >
        ...
        <div className="flex-shrink-0 w-[280px] sm:w-[320px] md:w-[380px] lg:w-[420px]">
          <div className="bg-accent-gold rounded-2xl p-6 sm:p-8 h-[400px] sm:h-[450px] flex flex-col justify-center items-center text-center">
