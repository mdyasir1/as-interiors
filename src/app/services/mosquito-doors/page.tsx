...
const mosquitoImages = [
  { src: '/mosquito doors/mosquito-door-09.jpg', alt: 'Mosquito Door Installation' },
  ...
  { src: '/mosquito doors/mosquito-door-07.jpg', alt: 'Mosquito Door Showcase' },
  { src: '/mosquito doors/mosquito-door-08.jpg', alt: 'Mosquito Door Premium' },
